...
// ✅ Dynamically load BlogCard for better performance
const BlogCard = dynamic(() => import("./BlogCard").then(mod => mod.BlogCard || mod.default), {
  ssr: false,
  loading: () => (
...
// ✅ Wrapped with Suspense for concurrent loading
export default function BlogsSection() {
  return (
    <SuspenseWrapper fallback={<div className="text-center py-20">Loading blogs...</div>}>
