...
// ✅ Lazy-load ContactForm to split bundle
const ContactForm = dynamic(() => import("./ContactForm"), {
  ssr: false,
  loading: () => (
    <div className="h-[500px] flex items-center justify-center bg-gray-100 rounded-3xl animate-pulse">
      Loading form...
    </div>
  ),
});

// ✅ SVG Check icon component (no change)
function Check() {
  return (
...
export default function ContactSection() {
  return (
    <SuspenseWrapper
      fallback={
        <div className="py-20 text-center">Loading contact section...</div>
      }
    >
      <section
      ...
      >
        {/* Gradient background */}
        <div className="absolute inset-0 -z-10 bg-[linear-gradient(180deg,#FFFFFF_0%,#D5ECF0_115.91%)]" />
          ...
          <div className="grid items-start gap-10 md:grid-cols-2 md:gap-14">
            ...
            <div className="space-y-6">
              <motion.div
                ...
                className="inline-flex items-center rounded-full border border-teal-600/30 bg-white/60 px-3 py-1 text-xs font-medium text-teal-700 shadow-sm backdrop-blur"
              >
                Contact us
              </motion.div>
                ...
                <div className="relative p-6 md:p-8">
                  ...
                  <ul className="space-y-4 text-sm leading-relaxed text-white/90 font-body">
                    ...
                    <li className="flex gap-3">
                      ...
                      Experience how your business aligns with WareGo – see how
                      we solve your warehousing challenges.
                    </li>
                    <li className="flex gap-3">
                      <span className="mt-0.5 inline-flex h-5 w-5 items-center justify-center rounded-full bg-green-500 text-white">
                        <Check />
            ...
            {/* Right form (lazy-loaded) */}
            <Suspense
              fallback={
                <div className="h-[500px] bg-gray-100 animate-pulse rounded-3xl" />
              }
            >
              <ContactForm />
            </Suspense>
        ...
        {/* Bottom curve */}
        <div className="relative h-32 w-full bg-white overflow-hidden">
          <svg
