...
export default function Card({
  ...
  const variantStyles = {
    dark: {
      ...
      title:
        "font-jakarta font-medium text-[20px] leading-[120%] text-white mt-6 mb-4",
      text:
        "font-jakarta font-normal text-[16px] leading-[140%] text-white max-w-[350px]",
      iconWrapper:
    ...
    classic: {
      wrapper:
        "p-6 border border-gray-100 shadow-sm rounded-2xl bg-gray-50",
      content: "flex flex-col",
      title: "font-medium text-[24px] leading-[32px] text-gray-900",
      text: "text-[16px] leading-[24px] text-gray-500",
      iconWrapper:
        "w-[32px] h-[32px] rounded-full border border-[var(--color-gradient-primary-2)] flex items-center justify-center",
    },
    simple: {
