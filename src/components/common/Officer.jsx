...
export default function TeamSection() {
  ...
  return (
    <section className="w-full bg-background py-16 px-4 sm:px-8 lg:px-16">
      {/* Heading + Subtext */}
      ...
      <div className="grid grid-cols-2 gap-6 sm:gap-8 lg:grid-cols-5 lg:gap-10">
        {teamMembers.map((member, idx) => (
          <div
            key={idx}
            className="flex flex-col items-start w-full sm:w-[233px] h-auto bg-background relative group"
          >
            {/* Image + Hover Overlay */}
