  ...
  return (
    <>
      <footer className="w-full flex justify-center px-4 py-10 relative z-10">
        <div
          className="
            w-[1312px] max-w-[95%] bg-[#02404B] rounded-[38px] 
            px-6 md:px-12 py-12
            md:rounded-[38px] 
        ...
        >
          ...
          <div className="flex flex-col md:flex-row justify-between gap-12 md:gap-20">
            ...
            <div className="flex flex-col gap-4 max-w-[442px]">
              ...
              />
              {/* Text */}
              <p className="text-[#EFEFEF] font-inter text-[16px] leading-[100%] sm:w-[306px] sm:h-[61px]">
            ...
            {/* Right Section */}
            <div className="flex flex-col sm:flex-row sm:gap-12 md:gap-20 text-[#EFEFEF]">
              {/* Navigation */}
              <div className="flex flex-col gap-7 sm:flex-1">
             ...
             <div className="flex flex-col gap-7 sm:flex-1">
  <h3 className="text-[20px] whitespace-nowrap">Support & Legals</h3>
  <div className="flex flex-col gap-7 text-[16px]">
    ...
    <Link href="#">Legal</Link>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            {/* Left Text */}
            <p className="text-[#EFEFEF] text-[16px] font-inter leading-[100%] sm:text-center">
              2025 Accurack, All rights reserved.
            </p>
            {/* Right Links */}
            <div className="flex gap-8 text-[16px] underline text-[#EFEFEF] font-inter leading-[100%] sm:justify-center sm:flex-wrap">
