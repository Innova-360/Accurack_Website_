...
function ItemRow({
  ...
  return (
    <m.li
      ...
      className={cn(
        "grid items-start gap-4 py-10 md:py-14 md:grid-cols-2",
      ...
      {isEven ? (
        <>
          ...
          <div className="order-1 md:order-2 px-2">
            <m.span
              className={cn(
                "block font-semibold tracking-tight text-6xl md:text-7xl font-heading",
                numberClassName
              )}
        ...
        <>
          ...
          <div className="order-2 px-2">
            <h3 className="text-xl md:text-2xl font-semibold font-body text-foreground">
              {item.title}
            </h3>
