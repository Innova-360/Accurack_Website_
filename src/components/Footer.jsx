...
export default function Footer() {
  return (
    <footer className="w-full flex justify-center px-4 py-10">
      <div className="w-[1312px] max-w-[95%] bg-primary rounded-[38px] px-6 md:px-12 py-12">
        {/* Top Section */}
        <div className="flex flex-col md:flex-row justify-between gap-12 md:gap-20">
          ...
          <div className="flex flex-col gap-4 max-w-[442px]">
            ...
            />
            {/* Text */}
            <p className="text-gray-100 text-[16px] leading-[100%] font-inter">
          ...
          {/* Right Section */}
          <div className="flex flex-col sm:flex-row gap-12 sm:gap-20 text-gray-100">
            {/* Navigation */}
        ...
        {/* Divider */}
        <div className="w-full border-t-2 border-stone-200/30 mt-12 mb-6" />
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          {/* Right Links */}
          <div className="flex gap-8 text-[16px] underline text-gray-100">
