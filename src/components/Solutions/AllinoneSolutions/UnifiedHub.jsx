...
export default function UnifiedHub() {
  return (
    <section className="w-full bg-white mt-16 mb-14">
      <div
        className="max-w-[1500px] mx-auto px-4 sm:px-8 lg:px-[60px] 
                   py-6 lg:py-12 grid grid-cols-1 lg:grid-cols-2 gap-10 items-stretch"
      >
        ...
        <motion.div
          ...
          className="flex flex-col justify-center h-full text-center lg:text-left lg:items-start items-center"
        >
          {/* Badge */}
          <span
          ...
          >
            The Unified Hub <br /> for Your Entire Business
          </h1>
          ...
          >
            Optimize stock, streamline operations, and enhance <br /> efficiency with
            Accurack&apos;s intelligent AI Warehouse Suite.
          </p>

          {/* Buttons */}
          <div
            className="mt-8 flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center lg:justify-start items-center w-full"
          >
            {/* Book a Demo */}
            <Button
              href="/book-demo"
        ...
        >
          <div className="relative inline-block h-full">
            ...
            {/* Main Image */}
            <Img
              src="/Images/Dropdownassests/Solutions/AllinoneSolutions/Hub.png"
