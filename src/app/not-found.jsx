...
const BlinkingEye = ({ delay, isMounted }) => {
  ...
  return (
    <m.div
      className="relative"
      animate={
        isMounted && isBlinking ? { scale: [1, 1, 0.1, 1] } : { scale: 1 }
      }
      ...
      <SuspenseWrapper>
        <div className="min-h-screen bg-background flex items-center justify-center p-6 relative overflow-hidden">
          ...
          >
            ...
            >
              Book a{" "}
              <span className="font-bold text-teal-700">30 minute call</span> to
              discuss your plans needs, and goals. We'll get on
            </m.p>
            <m.p
