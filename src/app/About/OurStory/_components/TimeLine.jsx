...
// LazyMotion only loads Framer features when needed
...
export default function TimelineComponent({
  ...
  // ✅ Memoize variants so they aren't re-created each render
  ...
  return (
    <LazyMotion features={loadFeatures}>
      <div className={`w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20 ${className}`}>
        {/* Header */}
        {(title || subtitle) && (
          <m.div
                    ...
                    >
                      ...
                      >
                        <path
                          d={
                            isEven
                              ? "M0,20 C60,0 100,60 160,40"
                              : "M0,80 C60,100 100,40 160,60"
                          }
                          stroke="#999"
                          strokeWidth="2"
                          strokeLinecap="round"
        ...
        {timelineItems.length > 0 && (
          ...
          >
            {timelineItems.map((item, index) => (
              <m.div key={index} variants={cardVariants} className="relative">
                {index < timelineItems.length - 1 && (
                ...
                >
                  <h3 className="text-3xl font-bold mb-3 italic text-gray-900">{item.year}</h3>
        ...
        {customerImpact && (
          <m.div
            className="relative rounded-3xl overflow-hidden bg-[#83DCEC] p-8 lg:p-12"
                ...
                {customerImpact.testimonial && (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4">
                      <Image
                        src={customerImpact.testimonial.image || "/api/placeholder/60/60"}
