  ...
  return (
    <section className="relative w-full min-h-[512px] flex items-center justify-center px-6 md:px-16 lg:px-24 overflow-hidden">
      ...
      <div className="max-w-[935px] flex flex-col items-start gap-6 text-left">
        {/* Smart Planning Tag */}
        <div
          className="font-body text-lighttext border border-lighttext rounded-2xl px-3 py-2 text-sm font-medium leading-5"
        >
          Smart Planning
        </div>
        ...
        {/* Heading */}
        <h2
          className="font-heading text-background text-[32px] sm:text-[40px] lg:text-[48px] font-medium leading-[48px] sm:leading-[56px] lg:leading-[60px]"
        >
        ...
        {/* Description Text */}
        <p
          className="font-body text-lighttext text-[14px] sm:text-[16px] leading-[24px] max-w-[723px]"
        >
          Estimate optimal stock levels, reorder points, and safety stock instantly. Reduce waste,
          avoid stockouts, and make data-driven purchasing decisions.
        </p>
